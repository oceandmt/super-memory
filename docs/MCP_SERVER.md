# Super Memory MCP Server (v2.2.0)
...
| **Line Citations** | `enrich_recall_with_citations`, `dialectic_answer` | all |
| **Dialectic** | `dialectic_answer` (format + synthesize modes) | all |
| **Curriculum** | `generate_curriculum`, `run_benchmark_tests` | admin |
