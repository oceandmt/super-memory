...
> **Plugin v1.7.1 / Super Memory v2.4.1**: current wrapper supports safe/admin/exclusive modes, caller-context forwarding, auto turn sync, optional context injection, and health-checked API integration. The matching Python package passed `856 passed, 22 skipped` before this release.
